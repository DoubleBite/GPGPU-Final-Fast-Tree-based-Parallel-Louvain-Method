...
void parallelLouvain(Dec_vec &d_nodes, Dec_vec &d_neighs, Dec_vec &d_oWeights, Dec_vec &d_iWeights, int n, int m){
    ...
    while(1){
        ...
        is_stop = onePassLouvain(d_comm_map, d_nodes, d_neighs, d_oWeights, d_iWeights, m);
